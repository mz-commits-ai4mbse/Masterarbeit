...
Die interne Finding-Kategorie oder Schweregradbezeichnung bestimmt dabei nicht
unmittelbar die wissenschaftliche Bedeutung eines Befunds. Für die Auswahl im
Haupttext ist entscheidend, ob ein Finding eine angenommene Verantwortungs-,
Informations-, Provenance- oder Authority-Grenze des Architekturkonzepts
infrage stellte oder eine wesentliche Ergebnisgrenze sichtbar machte.

Architekturwirksame Findings führten zu einer begründeten
Architekturkorrektur, deren Umsetzung anschließend am betroffenen
Verarbeitungspfad erneut geprüft wurde. Technische Blocker ohne
Architekturwirkung wurden auf Implementierungsebene korrigiert und retestet.
Nach Erreichen des vorgesehenen Proof-of-Concept-Umfangs verbliebene
nicht blockierende semantische, integrative oder bedienungsbezogene Findings
wurden als dokumentierte Limitationen beziehungsweise Ausgangspunkte für die
weitere Entwicklung erhalten.
...
\textbf{Erstbeobachtung:}
Die R4c-Klassifikation war als Tupel aus \texttt{information\_type},
\texttt{modality} und \texttt{epistemic\_status} modelliert, während der
...
\textbf{Thesis-Verwendung:}
Unterstützende formative Evidenz für die Diskussion von Laufzeit,
LLM-Call-Volumen und begrenzten Verarbeitungseinheiten in
Abschnitt~\ref{sec:discussion_limitations}. Die Beobachtung ist von der
separaten Tokenmessung des Referenzlaufs~930444 zu unterscheiden.
...
\textbf{Thesis-Verwendung:}
Dokumentierte PoC-Grenze und Grundlage der Limitationen in
...
Das Register erhält die vollständige, für die Arbeit relevante
Finding-Population in thesisgerecht verdichteter Form. Die technischen
Primärartefakte und ausführlicheren historischen Projektprotokolle verbleiben
im Entwicklungsrepository.

Kapitel~7 übernimmt aus diesem Register nur solche Befunde einzeln, die eine
wesentliche Evaluationsbeobachtung darstellen oder eine spätere
Architekturkorrektur ausgelöst haben. Die Auswahl erfolgt dabei nicht anhand
der internen Finding-Kategorie, sondern anhand ihrer Bedeutung für den
Untersuchungsgegenstand. Technische Detailfehler sowie UX- und
Integrationsbeobachtungen werden nur dort im Haupttext aufgegriffen, wo sie
eine relevante Systemgrenze sichtbar machen.

Kapitel~8 ordnet die ausgewählten Ergebnisse anschließend gegenüber dem
Forschungsstand und den Forschungsfragen ein. Ein später erfolgreich
retesteter Verarbeitungspfad hebt die historische Erstbeobachtung eines
Findings dabei nicht auf. Erstbeobachtung, Reaktion und Retest bilden
gemeinsam die Evaluationsevidenz.
