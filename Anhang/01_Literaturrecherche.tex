...
\label{app:literaturrecherche}

\subsection{Literature Search Plan}
\label{app:lsp}
...
%\subsection{Literatur Such Plan (LSP): Architecture as Code}

In diesem Abschnitt wird die methodische Planung der Literatursuche dargelegt. Die Struktur orientiert sich an etablierten Standards für die Erstellung systematischer Übersichtsarbeiten im Systems Engineering.
...
\begin{table}[h]
\caption[Beschreibung der PICOC Kriterien]{Beschreibung der PICOC Kriterien} % Dieser Text erscheint im Verzeichnis
...
Die Suchstrategie kombiniert eine zeitliche Eingrenzung mit ergänzendem
Snowballing sowie definierten Sprach- und Dokumentenfiltern.


\paragraph{Zeitliche Eingrenzung}
...
\paragraph{Avalanche Methode (Snowballing)}
...
\subsubsection{Ergänzende Suche mittels Scopus AI}
...
\paragraph{Forschungsfragen als Suchparameter}
...
\paragraph{Dublettenvermeidung und Integration}
...
\subsubsection{Dokumentation und Screening}
...
\end{itemize}
\subsubsection{Bewertung der Daten (Appraisal)}
...
\subsubsection{Detaillierte Screening Kriterien (Level 1)}
...
\paragraph{Einschlusskriterien (Inclusion Criteria)}
...
\begin{table}[h]
\caption[Einschlusskriterien für das Level 1 Screening]{Einschlusskriterien für das Level 1 Screening}
...
\end{table}
\newpage
\paragraph{Ausschlusskriterien (Exclusion Criteria)}
...
\begin{table}[h]
\caption[Ausschlusskriterien für das Level 1 Screening]{Ausschlusskriterien für das Level 1 Screening}
...
\subsection{Literature Search Report}
\label{app:lsr}

% initiale Suchergebnisse
% Screeningzahlen
% vollständige Screening-Tabelle
% ggf. PRISMA-Darstellung
%\subsection{Literatur Such Report (LSR): Architecture as Code}
...
\subsubsection{Ergebnisse des Level 1 Screenings}
...
\subsubsection{State of the Art (SotA) Statement}
...
\newpage
\subsubsection{Vollständige Ergebnisse des Level 1 Screenings}

\begin{xltabular}{\textwidth}{|l|X|l|l|}
\caption[Ergebnisse des Level 1 Screenings]{Vollständige Ergebnisse des Level 1 Screenings (ID 1 bis 28)} \label{tab:screening_full} \\
\hline
