...
die Verarbeitung mehrerer Engineering-Quellen sowie die Validierung des
erzeugten SysML-v2-Artefakts. Die Ergebnisse werden jeweils gemeinsam mit
dem zugehörigen Prüfverfahren dargestellt.
...
\begin{itemize}
    ...
    \item Die Validierung des erzeugten SysML-v2-Artefakts
...
Integrations- und Regressionstests eingesetzt. 
...
Verarbeitungsschritte und ihrer Übergänge. Die
...
in einer extern begleiteten Demonstration über den
...
der durchgängigen Nachverfolgbarkeit.
