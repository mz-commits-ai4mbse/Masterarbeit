...
Eine konkrete Grundlage für eine solche Übertragung bildet die in
Abschnitt~\ref{sec:implementation_configuration} beschriebene Trennung
zwischen der grundlegenden Verarbeitungspipeline und fach-, modell- sowie
zielspezifischer Konfiguration. Persona-Perspektiven, Teamzusammenstellungen,
Modellierungsrahmen und Teile der Zielabbildung werden im Prototyp über
versionierte Markdown- beziehungsweise JSON-Konfigurationen festgelegt.
Exemplarische Originalausschnitte dieser Konfigurationen sind in
Anhang~\ref{app:configuration_examples} dokumentiert. Damit ist bereits im
untersuchten Prototyp eine technische Trennung angelegt, an die eine
Übertragung auf andere Engineering-Aufgaben anknüpfen kann.
...
konkretisiert. Hierfür liegen Adaptionsbeschreibungen für drei alternative
Anwendungsszenarien vor. Die Dokumente unterscheiden jeweils zwischen
generischen Bestandteilen, die weiterverwendet werden können, und fach-
beziehungsweise zielspezifischen Bestandteilen, die konfiguriert, ersetzt
oder ergänzt werden müssten. Zu den vorgesehenen wiederverwendbaren
